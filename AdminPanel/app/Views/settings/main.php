...
<form id="settings-form" method="post" action="<?= baseUrl("ajax/settings") ?>">
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="form-group mb-2">
                <label class="form-label">ثبت دامنه</label>
                <input value="<?= $domainUrl ?>" type="url" name="domain_url" class="form-control text-end dir-ltr" placeholder="e.g. http://sub.example.com" />
            </div>
            <div class="alert alert-warning py-2">
               درصورت تغییر دامنه تمامی عملیات سیستم به روی دامنه جدید انتقال پیدا می کند
            </div>
            <div class="form-group mb-2">
