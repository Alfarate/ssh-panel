<div class="row mb-3">
    ...
    <div class="col-lg-3 mb-4">
        <div class="card h-100">
            ...
            <div class="card-footer d-flex align-items-center justify-content-between small">
                <a class="stretched-link" href="<?= baseUrl("users?status=active") ?>">مشاهده کاربران</a>
                <div class="fs-6">
                    <?= inlineIcon("chevron-left") ?>
                </div>
            </div>
    ...
    <div class="col-lg-3 mb-4">
        <div class="card h-100">
            ...
            <div class="card-footer d-flex align-items-center justify-content-between small">
                <a class="stretched-link" href="<?= baseUrl("users?status=de_active") ?>">مشاهده کاربران</a>
                <div class="fs-6">
                    <?= inlineIcon("chevron-left") ?>
                </div>
            </div>
        ...
        <div class="card border-left-primary h-100 py-2">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between flex-row-reverse mt-1">
                    <div class="unicode-bidi-plain"> <b><?= $ramData["total"] ?></b></div>
    ...
    <div class="col-lg-3 mb-4">
        <div class="card border-left-success h-100 py-2">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between flex-row-reverse mt-1">
                    <div class="unicode-bidi-plain"><b><?= $diskData["total"] ?></b></div>
